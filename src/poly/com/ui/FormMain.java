...
public class FormMain extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        pnlKhoahocLayout.setVerticalGroup(
            ...
            .addGroup(pnlKhoahocLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(tabbedPaneKhoahoc, javax.swing.GroupLayout.PREFERRED_SIZE, 639, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    private void btnAdd_pnlChuyendeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAdd_pnlChuyendeActionPerformed
        // TODO add your handling code here:
        String maCD = txtMachuyende_pnlChuyende.getText();
        String tenCD = txtTenchuyende_pnlChuyende.getText();
        String thoiLuong = txtThoiluong_pnlChuyende.getText();
        String hocPhi = txtHocphi_pnlChuyende.getText();
        String moTa = txtMota_pnlChuyende.getText();
        if (validate_formCD(maCD, tenCD, thoiLuong, hocPhi, moTa)) {
            addCD(maCD, tenCD, thoiLuong, hocPhi, moTa);
            fillTableCD();
        }
    ...
    private void btnAdd_pnlHocvienActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAdd_pnlHocvienActionPerformed
        ...
        if (validate_formHV()) {
            System.out.println(addHV(kh, arrHV));
            fillTableHV();
            fillTableThongKeHV();
    ...
    private void btnAdd_pnlNguoihocActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAdd_pnlNguoihocActionPerformed
        // TODO add your handling code here:
        String maNH = txtManguoihoc_pnlNguoihoc.getText();
        String hoTen = txtHovaten_pnlNguoihoc.getText();
        Date ngaySinh = dateNgaysinh_pnlNguoihoc.getDate();
        String SDT = txtSodienthoai_pnlNguoihoc.getText();
        String email = txtEmail_pnlNguoihoc.getText();
        boolean gioiTinh = cboGioitinh_pnlNguoihoc.getSelectedIndex() == 0 ? true : false;
        String ghiChu = txtGhichu_pnlNguoihoc.getText();
        if (validate_formNH(maNH, hoTen, ngaySinh, SDT, email)) {
            addNH(maNH, hoTen, ngaySinh, SDT, email, gioiTinh, ghiChu);
            fillTableNH();
            fillTableTKNguoiHoc();
        }
    ...
    private void btnAdd_pnlKhoahocActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAdd_pnlKhoahocActionPerformed
        // TODO add your handling code here:
        Date ngayKhaiGiang = dateNgaykhaigiang_pnlKhoahoc.getDate();
        String hocPhi = txtHocphi_pnlKhoahoc.getText();
        String thoiLuong = txtThoiluong_pnlKhoahoc.getText();
        String nguoiTao = txtNguoitao_pnlKhoahoc.getText();
        String ngayTao = txtNgaytao_pnlKhoahoc.getText();
        String ghiChu = txtGhichu_pnlKhoahoc.getText();
        Chuyende cd = (Chuyende) cboChuyende_pnlKhoahoc.getSelectedItem();
        if (validate_formKH(ngayKhaiGiang, hocPhi, thoiLuong, nguoiTao, ngayTao)) {
            addKH(cd, hocPhi, thoiLuong, ngayKhaiGiang, ghiChu);
            fillTableKH();
    ...
    private void btnAdd_pnlNhanvienActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAdd_pnlNhanvienActionPerformed
        // TODO add your handling code here:
        String maNV = txtManhanvien_pnlNhanvien.getText();
        String matKhau = txtMatkhau_pnlNhanvien.getText();
        String xacNhanMK = txtXacnhanmatkhau_pnlNhanvien.getText();
        String hoTen = txtHoten_pnlNhanvien.getText();
        boolean vaiTro = rdoNhanvien_pnlNhanvien.isSelected() ? false : true;
        if (validate_formNV(maNV, matKhau, xacNhanMK, hoTen)) {
            addNV(maNV, matKhau, hoTen, vaiTro);
            fillTableNV();
        }
    ...
    private void btnUpdate_pnlChuyendeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdate_pnlChuyendeActionPerformed
        ...
        String hocPhi = txtHocphi_pnlChuyende.getText();
        String moTa = txtMota_pnlChuyende.getText();
        updateCD(maCD, tenCD, thoiLuong, hocPhi, moTa);
    ...
    private void btnUpdate_pnlKhoahocActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdate_pnlKhoahocActionPerformed
        ...
        String ngayTao = txtNgaytao_pnlKhoahoc.getText();
        String ghiChu = txtGhichu_pnlKhoahoc.getText();
        String maKH = cboChuyende_pnlKhoahoc.getActionCommand();
        updateKH(maKH, ngayKhaiGiang, hocPhi, thoiLuong, nguoiTao, ngayTao, ghiChu);
    ...
    private void btnUpdate_pnlNhanvienActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdate_pnlNhanvienActionPerformed
        ...
        boolean vaiTro = rdoNhanvien_pnlNhanvien.isSelected() ? false : true;
        if (validate_formNV(maNV, matKhau, xacNhanMK, hoTen)) {
            updateNV(maNV, matKhau, hoTen, vaiTro);
        }
    ...
    private void btnUpdate_pnlNguoihocActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdate_pnlNguoihocActionPerformed
        ...
        boolean gioiTinh = cboGioitinh_pnlNguoihoc.getSelectedIndex() == 0 ? true : false;
        String ghiChu = txtGhichu_pnlNguoihoc.getText();
        System.out.println(updateNH(maNH, hoTen, ngaySinh, SDT, email, gioiTinh, ghiChu));
    ...
    private void btnScoreupdate_pnlHocvienActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnScoreupdate_pnlHocvienActionPerformed
        ...
        Khoahoc kh = (Khoahoc) cboKhoahoc_pnlHocvien.getSelectedItem();
        System.out.println(updateScore(rows, kh));
    ...
    public boolean validate_formNV(String maNV, String matKhau, String xacNhanMatKhau, String hoTen) {
        ...
        if (!xacNhanMatKhau.trim().equals(matKhau.trim())) {
    ...
    public boolean validate_formCD(String maCD, String tenCD, String thoiLuong, String hocPhi, String moTa) {
        if (maCD.isEmpty()) {
    ...
    public boolean validate_formHV() {
    ...
    public boolean validate_formNH(String maNH, String hoTen, Date ngaySinh, String SDT, String email) {
    ...
    public boolean validate_formKH(Date ngayKhaiGiang, String hocPhi, String thoiLuong, String nguoiTao, String ngayTao) {
    ...
    private int addCD(String maCD, String tenCD, String thoiLuong, String hocPhi, String moTa) {
        try {
            byte image[] = castImageToByte();
            if (chuyendeDAO.selectById(maCD) == null) {
                Chuyende cd = new Chuyende(maCD.trim(), tenCD.trim(), Integer.valueOf(thoiLuong.trim()), Double.valueOf(hocPhi.trim()), image, moTa.trim());
    ...
    public int addNV(String maNV, String matKhau, String hoTen, boolean vaiTro) {
        if (nhanvienDAO.selectById(maNV) == null) {
    ...
    private int addKH(Chuyende cd, String hocPhi, String thoiLuong, Date ngayKhaiGiang, String ghiChu) {
        Khoahoc kh = new Khoahoc();
        kh.setMaKH(0);
        kh.setHocPhi(Double.valueOf(hocPhi.trim()));
        kh.setThoiLuong(Integer.valueOf(thoiLuong.trim()));
        kh.setNgayKG(XDate.toDate(XDate.toString(ngayKhaiGiang, "yyyy-MM-dd"), "yyyy-MM-dd"));
        kh.setGhiChu(ghiChu);
    ...
    private int addNH(String maNH, String hoTen, Date ngaySinh, String SDT, String email, boolean gioiTinh, String ghiChu) {
        try {
            if (nguoihocDAO.selectById(maNH) == null) {
                Nguoihoc nh = new Nguoihoc();
                nh.setMaNH(maNH.trim());
                nh.setHoTen(hoTen.trim());
                nh.setGioiTinh(gioiTinh);
                nh.setNgaySinh(XDate.toDate(XDate.toString(ngaySinh, "yyyy-MM-dd"), "yyyy-MM-dd"));
                nh.setSoDienThoai(SDT.trim());
                nh.setEmail(email.trim());
                nh.setGhiChu(ghiChu.trim());
    ...
    private int addHV(Khoahoc kh, int[] arrHV) {
        boolean flag = true;
        int index = 0;
        try {
            if (arrHV.length != 0) {
    ...
    private int deleteCD(String maCD) {
        int index = chuyendeDAO.delete(maCD.trim());
        if (index > 0) {
    ...
    private int updateCD(String maCD, String tenCD, String thoiLuong, String hocPhi, String moTa) {
        if (validate_formCD(maCD, tenCD, thoiLuong, hocPhi, moTa)) {
            try {
                byte[] image;
                ...
                chuyendeDAO.update(new Chuyende(maCD, tenCD, Integer.valueOf(thoiLuong), Double.valueOf(hocPhi), image, moTa));
    ...
    private int deleteKH(Khoahoc cd) {
        int index = 0;
        index = khoahocDAO.delete(cd.getMaKH());
        if (index > 0) {
    ...
    private int updateKH(String maKH, Date ngayKhaiGiang, String hocPhi, String thoiLuong, String nguoiTao, String ngayTao, String ghiChu) {
        int index = 0;
        if (validate_formKH(ngayKhaiGiang, hocPhi, thoiLuong, nguoiTao, ngayTao)) {
            try {
                Chuyende cd = (Chuyende) cboChuyende_pnlKhoahoc.getSelectedItem();
                ...
                kh.setHocPhi(Double.valueOf(hocPhi));
                kh.setThoiLuong(Integer.valueOf(thoiLuong));
                kh.setNgayKG(XDate.toDate(XDate.toString(ngayKhaiGiang, "yyyy-MM-dd"), "yyyy-MM-dd"));
                kh.setGhiChu(ghiChu);
                kh.setNgayTao(XDate.now());
                kh.setMaNVTao(Auth.user.getMaNV());
                kh.setMaCD(cd.getMaCD());
                index = khoahocDAO.update(kh);
                MsgBox.alert(this, "Cập nhật thành công");
                mouseExitedColor(btnUpdate_pnlKhoahoc);
                fillTableKH();
                fillTableToCboNamTK();
    ...
    public int deleteNV(String id) {
        try {
            int index = nhanvienDAO.delete(id);
            MsgBox.alert(this, "Xóa thành công");
            fillTableNV();
            clearFormNV();
            mouseExitedColor(btnDelete_pnlNhanvien);
    ...
    public int updateNV(String maNV, String matKhau, String hoTen, boolean vaiTro) {
        try {
            Nhanvien nv = new Nhanvien(maNV, matKhau, hoTen, vaiTro);
            int index = nhanvienDAO.update(nv);
            MsgBox.alert(this, "Cập nhật thành công");
            mouseExitedColor(btnUpdate_pnlNhanvien);
    ...
    private int deleteNH(String maNH) {
        int index = 0;
        index = nguoihocDAO.delete(maNH.trim());
        if (index > 0) {
            MsgBox.alert(null, "Xóa thành công");
            fillTableNH();
            fillTableTKNguoiHoc();
    ...
    private int updateNH(String maNH, String hoTen, Date ngaySinh, String SDT, String email, boolean gioiTinh, String ghiChu) {
        int index = 0;
        try {
            Nguoihoc nh = new Nguoihoc();
            nh.setMaNH(maNH.trim());
            ...
            nh.setEmail(email.trim());
            nh.setGhiChu(ghiChu.trim());
            nh.setNgayDK(nguoihocDAO.selectById(maNH.trim()).getNgayDK());
            nh.setMaNVTao(Auth.user.getMaNV());
            index = nguoihocDAO.update(nh);
            MsgBox.alert(this, "Cập nhật thành công");
            fillTableNH();
            fillTableTKNguoiHoc();
            clearFormNH();
    ...
    private int deleteHV(int[] arrHV) {
        int index = 0;
    ...
    private int updateScore(int rows, Khoahoc kh) {
        boolean flag = false;
        int index = 0;
