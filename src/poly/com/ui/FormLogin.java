...
public class FormLogin extends javax.swing.JFrame {
    ...
    public boolean validate_form(String user, String pass) {
        if (user.isEmpty() || user.equals("Enter username...") || user == null) {
            txtUsername.requestFocus();
            MsgBox.alert(this, "Không được để trống Username");
            return false;
        }
        if (pass.trim().isEmpty() || pass.equals("Enter password...") || pass == null) {
